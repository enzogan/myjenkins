...
<div id="header-ontop" class="is-sticky"></div>
	...
	<div id="header" class="header style2 style3">
			...
			<div class="container">
				...
				<ul class="kt-nav top-bar-menu right">
					<li class="menu-item-has-children">
						<a href="#"><span class="menu-icon flaticon-user5"></span> Account</a>
						<ul class="sub-menu">
							<li><a href="#"><span class="menu-icon flaticon-two298"></span>Compare</a></li>
							<li><a href="#"><span class="menu-icon flaticon-heart295"></span>Wishlist</a></li>
							<li><a href="#"><span class="menu-icon flaticon-right33"></span>Checkout</a></li>
							<li><a href="#"><span class="menu-icon flaticon-user5"></span>Register/Login</a></li>
						</ul>
					</li>
					<li class="menu-item-has-children box-setting">
						<a href="#"><span class="menu-icon flaticon-configuration21"></span> Setting</a>
						<div class="sub-menu box-setting-content">
							<div class="box-section">
								<h4 class="title">Select your language:</h4>
								<div class="inner">
									<a href="#"><img src="images/icons/1.png" alt=""></a>
									<a href="#"><img src="images/icons/2.png" alt=""></a>
									<a href="#"><img src="images/icons/3.png" alt=""></a>
									<a href="#"><img src="images/icons/4.png" alt=""></a>
								</div>
							</div>
		...
		<div class="main-header">
			<div class="container">
				<div class="logo">
					<a href="#"><img src="images/logos/2.png" alt=""></a>
				</div>
					...
					<form class="advanced-search">
						<div class="category-dropdwon">
							<select>
								...
								<option value="">Small Storage</option>
							</select>
						</div>
				...
				<div class="mini-cart">
					...
					<div class="sub-menu mini-cart-content">
						<div class="content-inner">
							<h3 class="box-title">You have <span class="count">1 item(s)</span> in your cart.</h3>
							<ul class="list-item-cart">
								<li class="item-cart">
									<div class="thumb">
										<a href="#"><img src="images/products/1.png" alt=""></a>
									</div>
									<div class="product-info">
										<h4 class="product-name"><a href="#">Stockholm Chair high Mosta gruancy</a></h4>
							...
							<a href="#" class="button primary">CHECK OUT</a>
						</div>
					</div>
				</div>
				<div class="main-menu-wapper">
					...
					<ul class="kt-nav main-menu clone-main-menu">
						...
						<li class="menu-item-has-children">
							...
							<ul class="sub-menu">
								<li class="menu-item-has-children">
									<a href="category-grid-fullwidth.html">Shop pages</a>
									<ul class="sub-menu">
								...
								<li class="menu-item-has-children">
									<a href="product-detailfullwidth.html">Product pages</a>
									<ul class="sub-menu">
										<li><a href="product-detailfullwidth.html">Product Fullwidth</a></li>
										<li><a href="product-detailsidebar.html">Product with Sidebar</a></li>
										<li><a href="product-detailzoom.html">Product with Zoom</a></li>
									</ul>
								</li>
							</ul>
						</li>
						<li class="menu-item-has-children item-megamenu">
							...
							<div class="sub-menu megamenu" style="width:1200px;">
								<div class="row">
									...
									<div class="col-sm-3">
										<a href="#"><img src="images/banners/21.jpg" alt=""></a>
									</div>
									<div class="col-sm-3">
										<a href="#"><img src="images/banners/22.jpg" alt=""></a>
									</div>
									<div class="col-sm-3">
										<a href="#"><img src="images/banners/23.jpg" alt=""></a>
									</div>
								</div>
							</div>
						</li>
						<li class="menu-item-has-children">
							...
							<ul class="sub-menu">
								...
								<li><a href="shoppingcart.html">Cart page</a></li>
								<li><a href="checkout.html">Checkout page</a></li>
								<li><a href="authentication.html">Authentication page</a></li>
...
tedsty
	...
	<div class="margin-top-60">
		<div class="container">
			<div class="row margin-0">
				<div class="col-sm-3 padding-0 hidden-sm">
					<div class="kt-banner block-banner-text" data-height="530" data-background="images/banners/18.jpg" data-positionright="40" data-verticalmiddle="middle">
						<a href="#" class="bg-image">Banner Bg</a>
					</div>
				</div>
				<div class="col-sm-12 col-md-9 padding-0">
					<div class="kt-tabs kt-tab-fadeeffect">
						<div class="tab-head">
							<h3 class="tab-title">Office Furniture</h3>
							<ul class="nav-tab ">
				                <li class="active"><a data-animated="fadeInUp" data-toggle="tab" href="#tab-1">Shoes & boots</a></li>
				                <li ><a data-animated="slideInLeft" data-toggle="tab" href="#tab-2">Clothes/Shirt</a></li>
				                <li><a data-animated="slideInRight" data-toggle="tab" href="#tab-1">Most Reviews</a></li>
				            </ul>
						</div>
			            <div class="tab-container">
			            	<div id="tab-1" class="tab-panel active">
			            		<div class="owl-carousel nav-center nav-style-1" data-loop="true" data-nav="true" data-dots="false" data-margin="0" data-responsive='{"0":{"items":1,"nav":"false"},"600":{"items":2},"1000":{"items":2}}'>
				            		<ul>
										<li class="product-item style4">
											<div class="product-inner">
												<div class="thumb has-second-image col-sm-5">
													<a href="#">
	...
	<div class="margin-top-60">
		<div class="container">
			<div class="kt-tabs kt-tab-fadeeffect">
				<div class="tab-head">
					<h3 class="tab-title">Digital & Electronic</h3>
					<ul class="nav-tab">
		                <li class="active"><a data-animated="fadeInUp" data-toggle="tab" href="#tab-3">Shoes & boots</a></li>
		                <li ><a data-animated="fadeInUp" data-toggle="tab" href="#tab-4">Clothes/Shirt</a></li>
		                <li><a data-animated="fadeInUp" data-toggle="tab" href="#tab-3">Most Reviews</a></li>
		            </ul>
				</div>
	            <div class="tab-container">
	            	<div id="tab-3" class="tab-panel active">
	            		<ul class="owl-carousel nav-center nav-style-1" data-loop="true" data-nav="true" data-dots="false" data-margin="0" data-responsive='{"0":{"items":1,"nav":"false"},"600":{"items":3},"1000":{"items":4}}'>
							<li class="product-item style3">
								<div class="product-inner">
									<div class="thumb has-second-image">
										<a href="#">
											<img src="images/products/43.jpg" alt="">
											<img class="second-image" src="images/products/44.jpg" alt="">
										</a>
										<div class="group-button">
											<a class="wishlist" href="#">Wishlist</a>
											<a class="button add_to_cart_button" href="#">Add to cart</a>
							...
							<li class="product-item  style3">
								<div class="product-inner">
									<div class="thumb has-second-image">
										<a href="#">
											<img src="images/products/44.jpg" alt="">
											<img class="second-image" src="images/products/45.jpg" alt="">
										</a>
										<div class="group-button">
											<a class="wishlist" href="#">Wishlist</a>
											<a class="button add_to_cart_button" href="#">Add to cart</a>
							...
							<li class="product-item style3">
								<div class="product-inner">
									<div class="thumb has-second-image">
										<a href="#">
											<img src="images/products/45.jpg" alt="">
											<img class="second-image" src="images/products/46.jpg" alt="">
										</a>
										<div class="group-button">
											<a class="wishlist" href="#">Wishlist</a>
											<a class="button add_to_cart_button" href="#">Add to cart</a>
							...
							<li class="product-item style3">
								<div class="product-inner">
									<div class="thumb has-second-image">
										<a href="#">
											<img src="images/products/46.jpg" alt="">
											<img class="second-image" src="images/products/44.jpg" alt="">
										</a>
										<div class="group-button">
											<a class="wishlist" href="#">Wishlist</a>
			...
			<a href="#" class="banner-image"><img src="images/banners/19.jpg" alt=""></a>
		</div>
	</div>
	<!-- Tab product -->
	<div class="margin-top-60">
		<div class="container">
			<div class="row margin-0">
				<div class="col-sm-3 padding-0 hidden-sm">
					<div class="kt-banner block-banner-text" data-height="530" data-background="images/banners/20.jpg" data-positionright="40" data-verticalmiddle="middle">
						<a href="#" class="bg-image">Banner Bg</a>
					</div>
				</div>
				<div class="col-sm-12 col-md-9 padding-0">
					<div class="kt-tabs kt-tab-fadeeffect">
						<div class="tab-head">
							<h3 class="tab-title">Fashion & Clothing</h3>
							<ul class="nav-tab ">
				                <li class="active"><a data-animated="fadeInUp" data-toggle="tab" href="#tab-7">Shoes & boots</a></li>
				                <li ><a data-animated="slideInLeft" data-toggle="tab" href="#tab-8">Clothes/Shirt</a></li>
				                <li><a data-animated="slideInRight" data-toggle="tab" href="#tab-7">Most Reviews</a></li>
				            </ul>
						</div>
			            <div class="tab-container">
				            		...
				            		<ul>
										<li class="product-item style4">
											<div class="product-inner">
												<div class="thumb has-second-image col-sm-5">
													<a href="#">
														<img src="images/products/36.jpg" alt="">
														<img class="second-image" src="images/products/35.jpg" alt="">
													</a>
													<a href="#" title="Quick View" class="button quick-view yith-wcqv-button">Quick View</a>
												</div>
												<div class="info col-sm-7">
										...
										<li class="product-item style4">
											<div class="product-inner">
												<div class="thumb has-second-image col-sm-5">
													<a href="#">
														<img src="images/products/38.jpg" alt="">
														<img class="second-image" src="images/products/37.jpg" alt="">
													</a>
													<a href="#" title="Quick View" class="button quick-view yith-wcqv-button">Quick View</a>
												</div>
												<div class="info col-sm-7">
									...
									<ul>
										<li class="product-item style4">
											<div class="product-inner">
												<div class="thumb has-second-image col-sm-5">
													<a href="#">
														<img src="images/products/35.jpg" alt="">
														<img class="second-image" src="images/products/38.jpg" alt="">
													</a>
													<a href="#" title="Quick View" class="button quick-view yith-wcqv-button">Quick View</a>
												</div>
												<div class="info col-sm-7">
										...
										<li class="product-item style4">
											<div class="product-inner">
												<div class="thumb has-second-image col-sm-5">
													<a href="#">
														<img src="images/products/37.jpg" alt="">
														<img class="second-image" src="images/products/36.jpg" alt="">
													</a>
													<a href="#" title="Quick View" class="button quick-view yith-wcqv-button">Quick View</a>
												</div>
												<div class="info col-sm-7">
	...
	<div class="margin-top-60">
		<div class="container">
			<div class="kt-tabs kt-tab-fadeeffect">
				<div class="tab-head">
					<h3 class="tab-title">Home Decoration</h3>
					<ul class="nav-tab">
		                <li class="active"><a data-animated="fadeInUp" data-toggle="tab" href="#tab-5">Shoes & boots</a></li>
		                <li ><a data-animated="fadeInUp" data-toggle="tab" href="#tab-6">Clothes/Shirt</a></li>
		                <li><a data-animated="fadeInUp" data-toggle="tab" href="#tab-5">Most Reviews</a></li>
		            </ul>
				</div>
	            <div class="tab-container">
	            	<div id="tab-5" class="tab-panel active">
	            		<div class="owl-carousel nav-center nav-style-1" data-loop="true" data-nav="true" data-dots="false" data-margin="0" data-responsive='{"0":{"items":1,"nav":"false"},"600":{"items":3},"1000":{"items":4}}'>
		            		<ul>
								<li class="product-item style3">
									<div class="product-inner">
										<div class="thumb has-second-image">
	...
	<div class="section-last-test-blog">
		<div class="container">
					...
					<div class="col-sm-12 col-md-4">
						<div class="widget widget_text">
							...
							<div class="textwidget">
								Cras ac tempus ipsum etiam eu libero suscipit. Zolutpat ante a malesuada nunc, junc sit amet elementum est semper leo vel ante vestibulum
							</div>
						</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-12 col-md-6">
								<div class="coppyright">Copyright © 2016 Platform.sh. All Rights Reserved.</div>
							</div>
							<div class="col-sm-12 col-md-6">
								<div class="payment">
